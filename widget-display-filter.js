                    ...
                    $.ajax({ 
                        ...
                        success: function(response, dataType) {
                            if(response.success){
                                ...
                                $('#widget-filter-edit-postid-' + hashtag).html(response.data); 
                                $('#widget-filter-postid-' + hashtag).html(response.lists);
                    ...
                    $.ajax({ 
                        ...
                        success: function(response, dataType) { 
                            if(response.success){
                                ...
                                $('#widget-filter-edit-category-' + hashtag).html(response.data); 
                                $('#widget-filter-category-' + hashtag).html(response.lists); 
        ...
        $( "#post_tag-dialog" ).dialog({
            ...
            buttons     : {  
                "O K": function() {
                    ...
                    var csvptag = $('.post_tagchecklist li input:checked').map(function(){ return $(this).attr("value"); }).get().join(',');
                    $.ajax({ 
                        type: 'POST', 
                        url: ajaxurl,
                        data: {
                        ...
                        success: function(response, dataType) { 
                            if(response.success){
                                ...
                                $('#widget-filter-edit-post_tag-' + hashtag).html(response.data); 
                                $('#widget-filter-post_tag-' + hashtag).html(response.lists); 
